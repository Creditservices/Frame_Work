...
public class MAIN_JOINT {
	public static String JsonData;
	public static String TC_Name;
	public static int StatusCode;
	public static String responseData;
	public static String updateQuery;
	public static Recordset MJ_recordSet;
	
	public static void getDetails(String userName, String password, String url) throws FilloException
		{
			MJ_recordSet = BaseClass.connection.executeQuery("Select * from MAIN_JOINT Where RUN_FLAG='Yes'");
			while (MJ_recordSet.next()) 
				{
					//##Get the test case details
					String tc_name = MJ_recordSet.getField("TC_NAME");
					String si_num = MJ_recordSet.getField("S_NO");
					String jsonData = MJ_recordSet.getField("JSON DATA");
					int expCode = Integer.parseInt(MJ_recordSet.getField("EXPECTED STATUS CODE"));
					...
					if (expCode==StatusCode) {
						updateQuery = "Update MAIN_JOINT Set RESULT ='PASS', ACTUAL='"+StatusCode+"', RESPONSE='"+responseData+"' Where TC_NAME='"+tc_name+"' and S_NO='"+si_num+"'";
					} else {
						updateQuery = "Update MAIN_JOINT Set RESULT ='FAIL', ACTUAL='"+StatusCode+"', RESPONSE='"+responseData+"' Where TC_NAME='"+tc_name+"' and S_NO='"+si_num+"'";
					}
